...
/**
 * Definition tree visitor.
 */
public class DefinitionTreeVisitor extends BLangNodeVisitor {
    private List<Location> definitions = new ArrayList<>();
    private String uri = "";

    public DefinitionTreeVisitor(TextDocumentServiceContext documentServiceContext) {
        this.definitions = documentServiceContext.get(DocumentServiceKeys.DEFINITIONS_LIST_KEY);
        this.uri = documentServiceContext.get(DocumentServiceKeys.FILE_URI_KEY);

        this.documentServiceContext.get(DocumentServiceKeys.COMPILER_CONTEXT_KEY)
//        TextDocumentServiceContext hoverContext  = (TextDocumentServiceContext) documentServiceContext.
//                    get(DocumentServiceKeys.ACTIVE_NODE_CONTEXT);
    ...
    public void visit(BLangFunction funcNode) {
        this.addDefinition(funcNode);
        funcNode.getBody().accept(this);
    }

    public void visit(BLangStruct structNode) {
        this.addDefinition(structNode);
    }

    public void visit(BLangService serviceNode) {
        this.addDefinition(serviceNode);
    }

    public void visit(BLangConnector connectorNode) {
        this.addDefinition(connectorNode);
    }
...
//        this.addSymbol(variableNode, variableNode.symbol, kind);
    ...
    private void addDefinition(BLangNode node) {
        this.
        this.definitions.add(new Location(this.uri, TextDocumentServiceUtil.getRange(node)));
    }
